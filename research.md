...
$$
F_\ell(k,r)
= \underbrace{b_1(r)\, j_\ell(kr)}_{\text{real space}}
- \underbrace{f\, j''_\ell(kr)}_{\text{RSD}}
+ \underbrace{aH\, \mathcal{B}\, \frac{j'_\ell(kr)}{k}}_{\text{Doppler}}
+ \underbrace{a^2 H^2\, \mathcal{A}\, \frac{j_\ell(kr)}{k^2}}_{\text{potential}}
+ \underbrace{\frac{\mathcal{B}}{f}\, \mathcal{I}_{\mathrm{ISW}}(k,r)}_{\text{ISW}}
- \underbrace{2(1-\mathcal{Q})\, \mathcal{I}_{\mathrm{TD}}(k,r)}_{\text{time-delay}}
- \underbrace{2(1-\mathcal{Q})\, \mathcal{I}_\kappa(k,r)}_{\text{lensing}}
$$
{% endraw %}
