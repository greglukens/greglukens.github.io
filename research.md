...
\\[F_\ell(k,r) = \underbrace{b_1(r) j_\ell(kr)}{real space} - \underbrace{f j_\ell''(kr)}{RSD} + \underbrace{aH \mathcal B \frac{j_\ell'(kr)}{k}}{Doppler} + \underbrace{a^2 H^2  \mathcal A \frac{j_\ell(kr)}{k^2}}{potential} + \underbrace{\frac{\mathcal B}{f} \mathcal I_\mathrm{ISW}(k,r)}{ISW} - \underbrace{2(1-\mathcal Q)\mathcal I_\mathrm{TD}(k,r)}{time-delay} - \underbrace{2(1-\mathcal Q)\mathcal I_\kappa(k,r)}{lensing} \\]
